    ...
    <div class="page-content">
                            ...
                            <ul class="nav-group-sub collapse show">
                                <li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
                                    ...
                                    <ul class="nav-group-sub collapse show">
                                        ...
                                        <li class="nav-item"><a href="sidebar_default_collapsible" class="nav-link active">Collapsible</a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Default Collapsible @endslot
                @endcomponent
                ...
                <div class="content pt-0">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Collapsible default sidebar</div>
                        Main sidebar has 4 states - default, resized, collapsed and hidden. Collapsed and hidden states are sharing the same CSS, the only difference is sidebar toggle button. This example demonstrates <code>collapsible</code> state.
