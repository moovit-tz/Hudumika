                            ...
                            <ul class="nav-group-sub collapse show">
                                <li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
                                    ...
                                    <ul class="nav-group-sub collapse show">
                                        ...
                                        <li class="nav-item"><a href="sidebar_default_hideable" class="nav-link active">Hideable</a></li>
            ...
            <div class="navbar navbar-expand-lg navbar-static shadow">
                <div class="container-fluid">
                    ...
                    <div class="d-none d-lg-block me-3">
                        <a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill sidebar-control sidebar-main-toggle">
