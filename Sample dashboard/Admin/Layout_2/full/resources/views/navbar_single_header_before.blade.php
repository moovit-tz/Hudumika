    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Before Header @endslot
                @endcomponent
                ...
                <div class="content pt-0">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Before page header</div>
                        Navbar can be also placed <strong>before</strong> <code>.page-header</code> container, so that navbar appears as a first component in page content section. Useful for extra navigation (links, tabs, settings etc).
