<!-- Main sidebar -->
		<div class="sidebar sidebar-main sidebar-expand-xl sidebar-main-resized">
					...
					<ul class="nav nav-sidebar" id="navbar-nav" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav-group-sub collapse" data-submenu-title="Page layouts">
								...
								<li class="nav-item"><a href="layout_liquid_content" class="nav-link">Liquid content</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
