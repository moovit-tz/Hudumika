...
<body>
    ...
    <div class="page-content">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-dark sidebar-expand-xl">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-body d-flex justify-content-center pb-1">
                        ...
                        <div>
                            <button type="button" class="btn btn-flat-white btn-icon btn-sm rounded-pill border-transparent sidebar-control sidebar-main-resize d-none d-xl-inline-flex">
            ...
            <!-- Upgrade plan block -->
            <div class="alert alert-dismissible bg-secondary bg-opacity-20 sidebar-resize-hide rounded p-3 m-3">
                <div class="d-flex mb-2">
                    <div class="d-inline-flex bg-light bg-opacity-10 lh-1 rounded-pill p-2">
        ...
        <!-- Secondary sidebar -->
        <div class="sidebar sidebar-secondary sidebar-dark sidebar-expand-xl border-start border-start-white border-opacity-15">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
                    ...
                    <div class="ms-auto">
                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-control sidebar-secondary-toggle d-none d-xl-inline-flex">
                            <i class="ph-arrows-left-right"></i>
                        </button>

                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-secondary-toggle d-xl-none">
                            <i class="ph-x"></i>
                        </button>
                    </div>
                </div>
