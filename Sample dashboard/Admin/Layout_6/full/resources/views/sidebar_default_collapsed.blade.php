...
<body>
    ...
    <div class="page-content">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-expand-xl sidebar-collapsed">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-body d-flex justify-content-center pb-1">
                        ...
                        <div>
                            <button type="button" class="btn btn-light btn-icon btn-sm rounded-pill border-transparent sidebar-control sidebar-main-toggle d-none d-xl-inline-flex">
                            ...
                            <ul class="nav-group-sub collapse show">
                                <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                                    ...
                                    <ul class="nav-group-sub collapse show">
                                        ...
                                        <li class="nav-item"><a href="sidebar_default_collapsed" class="nav-link active">Collapsed</a></li>
            ...
            <div class="alert alert-dismissible bg-secondary bg-opacity-20 sidebar-resize-hide rounded p-3 m-3">
                <div class="d-flex mb-2">
                    <div class="d-inline-flex bg-secondary bg-opacity-20 lh-1 rounded-pill p-2">
                ...
                <a href="#" class="d-inline-flex align-items-center mt-1">
                    Upgrade now
