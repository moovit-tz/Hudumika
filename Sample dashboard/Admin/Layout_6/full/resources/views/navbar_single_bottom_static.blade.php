            ...
            <div class="content-inner">
                ...
                <div class="content container pt-0">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Bottom static navbar</div>
                        By default, footer (or bottom navbar) is always sticked to the bottom of the page and scrolls away along with page content, where <code>.content</code> and <code>.navbar</code> are children elements of <code>.content-inner</code> container.
