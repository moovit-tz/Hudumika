        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                <div class="content container pt-0">
                    ...
                    <!-- Inner container -->
                    <div class="d-flex align-items-stretch align-items-xl-start flex-column flex-xl-row">

                        <!-- Left content -->
                        <div class="flex-1 order-2 order-xl-1">
                        ...
                        <div class="sidebar sidebar-component sidebar-expand-xl border rounded shadow-sm order-1 order-xl-2 ms-xl-3 mb-3">

                            <!-- Sidebar content -->
                            <div class="sidebar-content">

                                <!-- Header -->
                                <div class="sidebar-section sidebar-section-body d-flex align-items-center d-xl-none pb-2">
