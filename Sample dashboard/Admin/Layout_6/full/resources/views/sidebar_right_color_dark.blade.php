...
<body>
    ...
    <div class="page-content">
        ...
        <!-- Right sidebar -->
        <div class="sidebar sidebar-dark sidebar-end sidebar-expand-xl">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
                    ...
                    <div class="ms-auto">
                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-control sidebar-end-toggle d-none d-xl-inline-flex">
                            <i class="ph-arrows-left-right"></i>
                        </button>

                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-end-toggle d-xl-none">
                            <i class="ph-x"></i>
                        </button>
                    </div>
                </div>
