            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                    ...
                    <ul class="nav-group-sub collapse show" data-submenu-title="Page layouts">
                        ...
                        <li class="nav-item"><a href="layout_navbar_sticky" class="nav-link">Sticky navbar</a></li>
                        ...
                        <li class="nav-item"><a href="layout_2_sidebars_2_sides" class="nav-link active">2 sidebars on 2 sides</a></li>
