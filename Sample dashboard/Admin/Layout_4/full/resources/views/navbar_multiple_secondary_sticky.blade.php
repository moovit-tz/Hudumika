...
<body>
    ...
    <!-- Navigation -->
	<div class="navbar navbar-sm sticky-top shadow" id="navigation-nav">
							...
							<div class="row">
								...
								<div class="col-md-3 mb-3 mb-md-0">
									...
									<div class="mb-3 mb-md-0">
										...
										<a href="navbar_multiple_secondary_sticky" class="dropdown-item rounded active">Secondary sticky</a>
									</div>
								</div>
								<div class="col-md-3 mb-3 mb-md-0">
    ...
    @slot('subtitle') Secondary Sticky @endslot
    @endcomponent
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="alert alert-success alert-dismissible">
                    ...
                    Secondary navbar can be sticked to the top or bottom when scroll position reaches the component, so that it doesn't scroll away with the content, but always stays on top. Just add <code>.sticky-top</code> class to <code>.navbar</code> container and CSS will do the rest. No JS required.
                                    ...
                                    <div class="container-fluid flex-column flex-sm-row">
                                        ...
                                        <ul class="nav">
                                            ...
                                            <li class="nav-item ms-md-1">
                                                <a href="https://demo.interface.club/limitless/demo/Documentation/index" class="navbar-nav-link navbar-nav-link-icon rounded" target="_blank">
                                                    <div class="d-flex align-items-center mx-md-1">
										...
										&lt;div class="navbar navbar-dark navbar-static navbar-expand-lg">
											&lt;div class="container-fluid">
												...
												&lt;div class="d-inline-flex flex-1 flex-lg-0">
													&lt;a href="index" class="navbar-brand d-inline-flex align-items-center">
														...
													&lt;/a>
												&lt;/div>
												&lt;!-- /navbar brand -->
