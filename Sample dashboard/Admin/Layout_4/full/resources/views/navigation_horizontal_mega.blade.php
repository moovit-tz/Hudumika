                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-2">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <a href="animations_velocity_basic" class="dropdown-item rounded">Animations <span class="badge bg-info rounded-pill ms-auto">14</span></a>
                                                        ...
                                                        <div class="tab-pane dropdown-scrollable-xl fade p-3" id="tab_navbars_demo">
                                                            <div class="row">
                                                                <div class="col-lg-3 mb-3 mb-lg-0">
                                                                    ...
                                                                    <a href="navbar_single_header_before" class="dropdown-item rounded">Before page header</a>
                                                                    <a href="navbar_single_header_before_fixed" class="dropdown-item rounded">Before page header fixed</a>
                                                                    <a href="navbar_single_header_after" class="dropdown-item rounded">After page header</a>
                                                                    <a href="navbar_single_header_after_sticky" class="dropdown-item rounded">After page header sticky</a>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/1.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/1.png')}}" alt="">
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/2.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/2.png')}}" alt="">
                                                                    <span class="card-img-actions-overlay rounded">
                                                                        <i class="ph-plus"></i>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/3.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/3.png')}}" alt="">
                                                                    <span class="card-img-actions-overlay rounded">
                                                                        <i class="ph-plus"></i>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/4.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/4.png')}}" alt="">
                                                                    <span class="card-img-actions-overlay rounded">
                                                                        <i class="ph-plus"></i>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/5.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/5.png')}}" alt="">
                                                                    <span class="card-img-actions-overlay rounded">
                                                                        <i class="ph-plus"></i>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-2">
                                                            <div class="card-img-actions mb-3">
                                                                <a href="{{URL::asset('assets/images/demo/flat/6.png')}}" class="text-white">
                                                                    <img class="img-fluid img-thumbnail" src="{{URL::asset('assets/images/demo/flat/6.png')}}" alt="">
                                                                    <span class="card-img-actions-overlay rounded">
                                                                        <i class="ph-plus"></i>
                                                                    </span>
                                                                </a>
