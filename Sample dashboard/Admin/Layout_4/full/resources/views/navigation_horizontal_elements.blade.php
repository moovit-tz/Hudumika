...
<body>
    ...
    @slot('subtitle') Nav elements @endslot
    @endcomponent
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="navbar-collapse collapse order-2 order-xl-1" id="navbar-demo-light">
                                    <ul class="navbar-nav mt-2 mt-xl-0">
                                        ...
                                        <li class="nav-item ms-xl-1">
                                            <a href="#" class="navbar-nav-link rounded">
                                                <img src="{{URL::asset('assets/images/pie-chart.png')}}" class="rounded-circle me-2" width="20" height="20" alt="">
                                                Image
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item ms-xl-1">
                                            <a href="#" class="navbar-nav-link rounded">
                                                <img src="{{URL::asset('assets/images/windows.svg')}}" class="me-2" width="20" height="20" alt="">
                                                SVG image
                                            </a>
                                        </li>
                                    </ul>
