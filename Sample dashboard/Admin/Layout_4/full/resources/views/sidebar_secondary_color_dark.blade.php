...
<body>
    ...
    <div class="page-content pt-0">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-dark sidebar-expand-lg sidebar-main-resized align-self-start">
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="../../layout_1/full/index" class="nav-link">Default layout</a></li>
                                <li class="nav-item"><a href="../../layout_2/full/index" class="nav-link">Layout 2</a></li>
                                <li class="nav-item"><a href="index" class="nav-link active">Layout 3</a></li>
                                <li class="nav-item"><a href="../../layout_4/full/index" class="nav-link">Layout 4</a></li>
                                <li class="nav-item"><a href="../../layout_5/full/index" class="nav-link">Layout 5</a></li>
                                <li class="nav-item"><a href="../../layout_6/full/index" class="nav-link">Layout 6</a></li>
                                <li class="nav-item"><a href="../../layout_7/full/index" class="nav-link disabled">Layout 7 <span class="opacity-75 fs-sm ms-auto">Coming soon</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Themes">
                                ...
                                <li class="nav-item"><a href="../../../LTR/material/full/index" class="nav-link disabled">Material <span class="opacity-75 fs-sm ms-auto">Coming soon</span></a></li>
                                <li class="nav-item"><a href="../../../LTR/clean/full/index" class="nav-link disabled">Clean <span class="opacity-75 fs-sm ms-auto">Coming soon</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Starter kit">
                                <li class="nav-item"><a href="../seed/layout_navbar_fixed" class="nav-link">Fixed navbar</a></li>
                                <li class="nav-item"><a href="../seed/layout_navbar_hideable" class="nav-link">Hideable navbar</a></li>
                                <li class="nav-item-divider"></li>
                                <li class="nav-item"><a href="../seed/layout_no_header" class="nav-link">No header</a></li>
                                <li class="nav-item"><a href="../seed/layout_no_footer" class="nav-link">No footer</a></li>
                                <li class="nav-item"><a href="../seed/layout_fixed_footer" class="nav-link">Fixed footer</a></li>
                                <li class="nav-item-divider"></li>
                                <li class="nav-item"><a href="../seed/layout_2_sidebars_1_side" class="nav-link">2 sidebars on 1 side</a></li>
                                <li class="nav-item"><a href="../seed/layout_2_sidebars_2_sides" class="nav-link">2 sidebars on 2 sides</a></li>
                                <li class="nav-item"><a href="../seed/layout_3_sidebars" class="nav-link">3 sidebars</a></li>
                                <li class="nav-item-divider"></li>
                                <li class="nav-item"><a href="../seed/layout_boxed_page" class="nav-link">Boxed page</a></li>
                                <li class="nav-item"><a href="../seed/layout_boxed_content" class="nav-link">Boxed content</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="../../../../docs/other_changelog" class="nav-link">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Page layouts">
                                <li class="nav-item"><a href="layout_navbar_fixed" class="nav-link">Fixed navbar</a></li>
                                <li class="nav-item"><a href="layout_navbar_hideable" class="nav-link">Hideable navbar</a></li>
                                <li class="nav-item-divider"></li>
                        ...
                        <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                            ...
                            <ul class="nav-group-sub collapse show" data-submenu-title="Sidebars">
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        ...
                                        <li class="nav-item-divider"></li>
                                        <li class="nav-item"><a href="sidebar_default_stretched" class="nav-link">Stretched</a></li>
                                ...
                                <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                                    ...
                                    <ul class="nav-group-sub collapse show">
                                        ...
                                        <li class="nav-item-divider"></li>
                                        <li class="nav-item"><a href="sidebar_secondary_stretched" class="nav-link">Stretched</a></li>
                                        <li class="nav-item"><a href="sidebar_secondary_color_dark" class="nav-link active">Dark color</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        ...
                                        <li class="nav-item-divider"></li>
                                        <li class="nav-item"><a href="sidebar_right_stretched" class="nav-link">Stretched</a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Navbars">
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        <li class="nav-item"><a href="navbar_single_top_static" class="nav-link">Top static</a></li>
                                        <li class="nav-item"><a href="navbar_single_top_fixed" class="nav-link">Top fixed</a></li>
                                        <li class="nav-item"><a href="navbar_single_bottom_static" class="nav-link">Bottom static</a></li>
                                ...
                                <li class="nav-item nav-item-submenu">
                                    ...
                                    <ul class="nav-group-sub collapse">
                                        ...
                                        <li class="nav-item"><a href="navbar_multiple_bottom_fixed" class="nav-link">Bottom fixed</a></li>
                                        <li class="nav-item"><a href="navbar_multiple_top_bottom_fixed" class="nav-link">Top and bottom fixed</a></li>
                                        <li class="nav-item"><a href="navbar_multiple_secondary_sticky" class="nav-link">Secondary sticky</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item nav-item-submenu">
