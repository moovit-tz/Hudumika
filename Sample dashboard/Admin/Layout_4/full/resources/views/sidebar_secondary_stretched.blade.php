...
<body>
    ...
    @slot('subtitle') Secondary stretched @endslot
    @endcomponent
    ...
    <div class="page-content pt-0">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-expand-lg sidebar-main-resized">
                    ...
                    <ul class="nav nav-sidebar" id="navbar-nav" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Themes">
                                ...
                                <li class="nav-item"><a href="javascrip:void(0)" class="nav-link disabled">Material <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
                                <li class="nav-item"><a href="javascrip:void(0)" class="nav-link disabled">Clean <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
                            </ul>
                        </li>
