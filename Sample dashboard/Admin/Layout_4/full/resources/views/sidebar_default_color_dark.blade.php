...
<body>
    ...
    @slot('subtitle') Default dark @endslot
    @endcomponent
    ...
    <div class="page-content pt-0">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-dark sidebar-expand-lg align-self-start">
                    ...
                    <ul class="nav nav-sidebar" id="navbar-nav" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse" data-submenu-title="Themes">
                                ...
                                <li class="nav-item"><a href="javascript:void(0)" class="nav-link disabled">Material <span class="opacity-75 fs-sm ms-auto">Coming soon</span></a></li>
                                <li class="nav-item"><a href="javascript:void(0)" class="nav-link disabled">Clean <span class="opacity-75 fs-sm ms-auto">Coming soon</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
