...
// mix.sass('resources/scss/layouts/layout_1/compile/bootstrap_limitless.scss', folder.dist_assets + "css/ltr").options({ processCssUrls: false }).minify(folder.dist_assets + "css/ltr/bootstrap_limitless.css");
