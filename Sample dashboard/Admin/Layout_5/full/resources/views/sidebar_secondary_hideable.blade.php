	...
	<div class="navbar navbar-dark navbar-expand-lg navbar-static px-lg-0">
		<div class="container-fluid container-boxed jusitfy-content-start">
			...
			<ul class="nav order-2 order-lg-1 ms-2 ms-lg-3 me-lg-auto">
				<li class="nav-item">
					<a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill sidebar-control sidebar-secondary-toggle d-none d-lg-flex">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="alert alert-success alert-dismissible">
                    ...
                    This example demonstrates <code>hideable</code> state. Sidebar toggler is moved outside the sidebar and added to page header. You can have this button anywhere - content, card or navbar. The only condition here is proper class names.
