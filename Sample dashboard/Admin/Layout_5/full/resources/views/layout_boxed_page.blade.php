...
<body>
    ...
    <!-- Navigation -->
    <div class="navbar navbar-dark" id="navigation-menu">
            ...
            <div class="flex-fill overflow-auto overflow-lg-visible scrollbar-hidden">
                <ul class="nav gap-1 flex-nowrap flex-lg-wrap">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu start-0 end-0 p-3 mx-2 mx-sm-3">
                            <div class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3 mb-lg-0">
                                        ...
                                        <a href="layout_boxed_page" class="dropdown-item rounded active">Boxed page</a>
