...
<body class="navbar-md-sm-top">
    ...
    <div class="fixed-top">
        ...
        <!-- Navigation -->
        <div class="navbar navbar-dark border-top border-top-white border-opacity-10 px-lg-0" id="navigation-nav">
                        ...
                        <li>
                            <div data-fab-label="Chat with Jack">
                                <a href="#" class="btn btn-link btn-icon status-indicator-container rounded-pill p-0 ms-1">
                                    <img src="{{URL::asset('assets/images/demo/users/face1.jpg')}}" class="img-fluid rounded-pill" alt="">
    ...
    <div class="page-header">
        <div class="page-header-content container-boxed d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title my-1">
                    Multiple Navbars - <span class="fw-normal">Top Fixed</span>
                </h4>
            ...
            <div class="collapse d-lg-block my-lg-auto ms-lg-auto" id="page_header">
                <div class="d-inline-flex align-items-center mb-2 mb-lg-0">
                    ...
                    <a href="#" class="status-indicator-container ms-1">
                        <img src="{{URL::asset('assets/images/demo/users/face6.jpg')}}" class="w-32px h-32px rounded-pill" alt="">
                    ...
                    <a href="#" class="btn btn-outline-primary btn-icon w-32px h-32px rounded-pill">
                        <i class="ph-plus"></i>
                    </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="alert alert-success alert-dismissible">
                    ...
                    You can have maximum of 2 <strong>top</strong> <code>fixed</code> navbars - since the element is removed from the normal document flow and no space is created for the element in the page layout, <code>&lt;body&gt;</code> requires additional classes in order to set correct top padding. That's why both navbars need to be wrapped in <code>.fixed-top</code> container and <code>&lt;body&gt;</code> container needs to have <code>.navbar-[size]-[size]-top</code> class. See the table below for classes explanation.
