        ...
        <Footer className={props.className && props.className} id={props.id && props.id}>
            ...
            <div className="bg-dark text-center is-dark py-3">
                <div className="container">
                    <div className="text-base"> &copy; 2025, DashLite. Template made by <a href="https://themeforest.net/user/softnio/portfolio" target="_blank" rel="noreferrer"> Softnio </a></div>
                </div>
            </div>
        </Footer>
    )
