                        ...
                        <Col lg="5" md="10">
                            <HeaderCaption>
                                ...
                                <ul className="header-action btns-inline">
                                    <li><Link to="/" className="btn-primary btn-lg"><span>Start Free Trial</span></Link></li>
                                    <li><a href="/" className="link link-block link-gray"><NioIcon className="icon-lg" icon="play-circle" /><span>Watch video</span></a></li>
                                </ul>
                            </HeaderCaption>
                        </Col>
                    </Row>
