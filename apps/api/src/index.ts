...
import { ondiRoutes }     from './routes/ondi.routes.js';
...
import { cmsExperimentsRoutes } from './routes/cms-experiments.routes.js';
import { cmsEnterpriseRoutes } from './routes/cms-enterprise.routes.js';
...
export async function registerApp() {
  ...
  registered = (async () => {
  {
    ...
    await server.register(ondiRoutes,     { prefix: '/v1/ondi' });
    ...
    await server.register(cmsExperimentsRoutes, { prefix: '/v1/cms' });
    await server.register(cmsEnterpriseRoutes, { prefix: '/v1/cms' });
