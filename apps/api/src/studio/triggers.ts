...
export const TRIGGERS: TriggerDef[] = [
  ...
  // ── OneSite / CMS ──────────────────────────────────────────────────
  {
    id: 'cms.approval_requested', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS approval requested', description: 'A writer or editor submitted a page, post, or content entry for review.',
    entityType: 'cms_approval',
    payloadSchema: z.object({ resource_type: z.string(), resource_id: z.string(), assigned_to: z.string(), title: z.string() }).passthrough(),
    samplePayload: { resource_type: 'page', resource_id: '00000000-0000-0000-0000-000000000000', assigned_to: '00000000-0000-0000-0000-000000000000', title: 'About Us' },
  },
  {
    id: 'cms.release_published', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS release published', description: 'A coordinated content release bundle was published live.',
    entityType: 'cms_release',
    payloadSchema: z.object({ release_id: z.string(), items_count: z.number(), name: z.string() }).passthrough(),
    samplePayload: { release_id: '00000000-0000-0000-0000-000000000000', items_count: 5, name: 'Q3 Product Launch' },
  },
  {
    id: 'page.created', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS page created', description: 'A new CMS page draft was created.',
    entityType: 'cms_page',
    payloadSchema: z.object({ title: z.string(), slug: z.string(), status: z.string() }).passthrough(),
    samplePayload: { title: 'Pricing', slug: 'pricing', status: 'draft' },
  },
  {
    id: 'page.published', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS page published', description: 'A CMS page was published live.',
    entityType: 'cms_page',
    payloadSchema: z.object({ title: z.string(), slug: z.string() }).passthrough(),
    samplePayload: { title: 'Pricing', slug: 'pricing' },
  },
  {
    id: 'page.deleted', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS page deleted', description: 'A CMS page was permanently deleted.',
    entityType: 'cms_page',
    payloadSchema: z.object({ title: z.string().nullable().optional(), slug: z.string().nullable().optional() }).passthrough(),
    samplePayload: { title: 'Old Page', slug: 'old-page' },
  },
  {
    id: 'post.created', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS blog post created', description: 'A new blog post draft was created.',
    entityType: 'cms_post',
    payloadSchema: z.object({ title: z.string(), slug: z.string(), status: z.string() }).passthrough(),
    samplePayload: { title: 'Spring Announcement', slug: 'spring-announcement', status: 'draft' },
  },
  {
    id: 'post.published', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS blog post published', description: 'A blog post was published live.',
    entityType: 'cms_post',
    payloadSchema: z.object({ title: z.string(), slug: z.string() }).passthrough(),
    samplePayload: { title: 'Spring Announcement', slug: 'spring-announcement' },
  },
  {
    id: 'post.deleted', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS blog post deleted', description: 'A blog post was permanently deleted.',
    entityType: 'cms_post',
    payloadSchema: z.object({ title: z.string().nullable().optional(), slug: z.string().nullable().optional() }).passthrough(),
    samplePayload: { title: 'Old Post', slug: 'old-post' },
  },
  {
    id: 'entry.created', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS content entry created', description: 'A new content entry was created under a content model.',
    entityType: 'cms_content_entry',
    payloadSchema: z.object({ title: z.string(), slug: z.string(), status: z.string() }).passthrough(),
    samplePayload: { title: 'Press Release 1', slug: 'press-release-1', status: 'draft' },
  },
  {
    id: 'entry.published', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS content entry published', description: 'A structured content entry was published live.',
    entityType: 'cms_content_entry',
    payloadSchema: z.object({ title: z.string(), slug: z.string() }).passthrough(),
    samplePayload: { title: 'Press Release 1', slug: 'press-release-1' },
  },
  {
    id: 'entry.deleted', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS content entry deleted', description: 'A structured content entry was permanently deleted.',
    entityType: 'cms_content_entry',
    payloadSchema: z.object({ title: z.string().nullable().optional(), slug: z.string().nullable().optional() }).passthrough(),
    samplePayload: { title: 'Old Entry', slug: 'old-entry' },
  },
  {
    id: 'media.uploaded', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS media uploaded', description: 'A new image or media file was uploaded to the CMS media library.',
    entityType: 'cms_media',
    payloadSchema: z.object({ filename: z.string(), mime_type: z.string() }).passthrough(),
    samplePayload: { filename: 'hero-banner.webp', mime_type: 'image/webp' },
  },
  {
    id: 'media.deleted', kind: 'DOMAIN_EVENT', app: 'onsite',
    label: 'CMS media deleted', description: 'A media file was permanently deleted from the CMS library.',
    entityType: 'cms_media',
    payloadSchema: z.object({ filename: z.string() }).passthrough(),
    samplePayload: { filename: 'old-hero.webp' },
  },
];
