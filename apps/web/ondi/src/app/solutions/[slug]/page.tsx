...
import { SOLUTIONS_DATA } from '@/data/menuPagesData';
import {
  Users,
  UserCheck,
  Shield,
...
export default function SolutionDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const config = SOLUTIONS_DATA[slug];
  ...
  const IconComponent = IconMap[config.iconName] || Shield;
    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#232323] font-sans selection:bg-[#ECEEFF] selection:text-[#4253D1] overflow-x-hidden">
      ...
      <section className="relative pt-56 pb-24 px-6 overflow-hidden bg-[#FAFAF8]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-6">
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest font-mono">Solutions / {config.category}</span>
          </motion.div>
            ...
            <div className="lg:col-span-7 space-y-12">
              <ScrollReveal y={20}>
                <div className="space-y-6">
                  ...
                  <h2 className="text-3xl lg:text-4xl font-bold text-[#001633] uppercase leading-tight">Industry Tailored Trust Infrastructure</h2>
              ...
              <ScrollReveal y={20} x={20}>
                <GlassPanel className="p-8 bg-white border-slate-100 shadow-2xl shadow-blue-900/5 relative rounded-[2rem] space-y-8">
                  <div className="space-y-2 border-b border-slate-100 pb-4">
                    ...
                    <h3 className="text-lg font-bold text-[#001633] uppercase">Deployment Specifications</h3>
                  </div>
      ...
      <section className="py-24 px-6 bg-[#001633] text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-10 relative z-10">
          <ScrollReveal y={16}>
            <div className="space-y-4">
              <h2 className="text-3xl lg:text-5xl font-bold uppercase leading-tight font-sans">Ready to launch this solution?</h2>
              <p className="text-sm text-white/50 leading-relaxed font-normal max-w-xl mx-auto">
                Discover your current digital trust maturity and receive a prioritised roadmap in under 5 minutes.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal y={16} delay={0.1}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/assessment" className="w-full sm:w-auto relative overflow-hidden group px-12 py-5 bg-[#4253D1] text-white rounded-full font-bold text-xs uppercase tracking-widest font-mono shadow-2xl shadow-blue-500/20 flex items-center justify-center gap-2">
