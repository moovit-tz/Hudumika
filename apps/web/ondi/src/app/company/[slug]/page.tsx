...
import { COMPANY_DATA } from '@/data/menuPagesData';
import {
  Scale,
  Compass,
  Briefcase,
...
export default function CompanyDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const config = COMPANY_DATA[slug];

  // If slug is invalid, redirect to about page
  useEffect(() => {
    if (!config) {
      router.push('/about');
    }
  ...
  const IconComponent = IconMap[config.iconName] || Compass;
    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#232323] font-sans selection:bg-[#ECEEFF] selection:text-[#4253D1] overflow-x-hidden">
      ...
      <section className="relative pt-56 pb-24 px-6 overflow-hidden bg-[#FAFAF8]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-6">
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest font-mono">Company / {config.category}</span>
          </motion.div>
            ...
            <div className="lg:col-span-7 space-y-12">
              <ScrollReveal y={20}>
                <div className="space-y-6">
                  <span className="text-xs font-bold text-[#4253D1] uppercase tracking-widest font-mono">Our Philosophy</span>
                  <h2 className="text-3xl lg:text-4xl font-bold text-[#001633] uppercase leading-tight">Shaping the future of African digital trust</h2>
              ...
              <ScrollReveal y={20} x={20}>
                <GlassPanel className="p-8 bg-white border-slate-100 shadow-2xl shadow-blue-900/5 relative rounded-[2rem] space-y-8">
                  <div className="space-y-2 border-b border-slate-100 pb-4">
                    ...
                    <h3 className="text-lg font-bold text-[#001633] uppercase">Operational Focus</h3>
                  </div>
                  ...
                  <div className="p-5 bg-[#FAFAF8] border border-slate-100 rounded-2xl space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-[#4B5563] leading-relaxed">
                        <span className="font-semibold text-[#001633]">Focus: </span>
                        {config.useCase.challenge}
                      </p>
                      <p className="text-[11px] text-[#4B5563] leading-relaxed">
                        <span className="font-semibold text-[#4253D1]">Resolution: </span>
      ...
      <section className="py-24 px-6 bg-[#001633] text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-10 relative z-10">
          <ScrollReveal y={16}>
            <div className="space-y-4">
              <h2 className="text-3xl lg:text-5xl font-bold uppercase leading-tight font-sans">Join the Ondi Alliance</h2>
              <p className="text-sm text-white/50 leading-relaxed font-normal max-w-xl mx-auto">
                Discover how your organization can participate in shaping the foundation of pan-African digital trust.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal y={16} delay={0.1}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/about" className="w-full sm:w-auto relative overflow-hidden group px-12 py-5 bg-[#4253D1] text-white rounded-full font-bold text-xs uppercase tracking-widest font-mono shadow-2xl shadow-blue-500/20 flex items-center justify-center gap-2">
                ...
                <span className="relative z-10">About Ondi</span>
                <ArrowRight size={14} className="relative z-10" />
              </Link>
              <Link href="/register/enterprise/kyb" className="w-full sm:w-auto px-12 py-5 border border-white/20 bg-white/5 text-white rounded-full font-bold text-xs uppercase tracking-widest font-mono hover:bg-white/10 transition-all flex items-center justify-center">
                Become a Partner
              </Link>
            </div>
          </ScrollReveal>
