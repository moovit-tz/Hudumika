    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
          <button type="button" onClick={onClose} style={{ background: 'transparent', border: '1px solid #fff', color: '#fff', padding: '6px 12px', borderRadius: '4px' }}>
            Cancel
          </button>
          <button type="submit" style={{ background: 'var(--teal)', border: 'none', color: '#fff', padding: '6px 12px', borderRadius: '4px' }}>
