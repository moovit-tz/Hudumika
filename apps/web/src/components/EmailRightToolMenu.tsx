            ...
            {activePanel === 'notifications' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button type="button" className="ertm-btn-primary" style={{ padding: 'var(--ds-btn-py-xs) 10px', fontSize: 11, minHeight: 'var(--ctl-h-xs)', boxSizing: 'border-box'}} onClick={handleMarkAllNotifsRead}>
                    Mark all read
                  </button>
                </div>
                {notifs.map((n: any) => (
