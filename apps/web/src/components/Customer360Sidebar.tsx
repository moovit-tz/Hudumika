            ...
            {aiLoading ? (
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  {onUseAiReply && (
                    <button
                      ...
                      style={{ flex: 1, padding: '8px 12px', background: 'var(--teal)', color: '#fff', border: 'none', borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'var(--font)' }}>
                      ✓ Use This Reply
                    </button>
                  )}
                  <button
                    type="button"
                    onClick={fetchAI}
                    style={{ padding: '8px 12px', background: 'var(--white)', color: 'var(--ink2)', border: '1px solid var(--border)', borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font)' }}>
                    ↺ Regenerate
                  </button>
                </div>
              </div>
              ...
              <div style={{ textAlign: 'center', padding: '32px 0' }}>
                ...
                <button type="button" onClick={fetchAI}
                  style={{ padding: '10px 20px', background: 'var(--teal)', color: '#fff', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'var(--font)' }}>
                  Generate Suggestion
                </button>
              </div>
            )}
