                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  {onUseAiReply && (
                    <button
                      ...
                      style={{ flex: 1, padding: 'var(--ds-btn-py) 12px', background: 'var(--teal)', color: '#fff', border: 'none', borderRadius: 'var(--r)', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'var(--font)' }}>
                      ✓ Use This Reply
                    </button>
                  )}
                  <button
                    type="button"
                    onClick={fetchAI}
                    style={{ padding: 'var(--ds-btn-py) 12px', background: 'var(--white)', color: 'var(--ink2)', border: '1px solid var(--border)', borderRadius: 'var(--r)', fontSize: 12, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font)' }}>
                    ↺ Regenerate
                  </button>
                </div>
              </div>
