      ...
      <div style={{ background:'var(--white)', borderBottom:'1px solid var(--border)', padding:'16px 24px', display:'flex', alignItems:'center', justifyContent:'space-between', flexShrink:0 }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          <button
            ...
            style={{ display:'flex', alignItems:'center', gap:6, padding:'var(--ds-btn-py) 14px', borderRadius: 'var(--r)', border:'1px solid var(--border)', background:'var(--white)', color:'var(--ink2)', fontSize:12, fontWeight:600, cursor:'pointer' }}
          >
          ...
          {HAS_UPDATE && !updateDone && (
            <button
              ...
              disabled={updating}
              style={{ display:'flex', alignItems:'center', gap:6, padding:'var(--ds-btn-py) 16px', borderRadius: 'var(--r)', border:'none', background: updating ? 'var(--ink3)' : 'var(--teal)', color:'#fff', fontSize:12, fontWeight:700, cursor: updating ? 'not-allowed' : 'pointer' }}
            >
          ...
          <div style={{ background:'var(--white)', borderRadius: 9, padding:'28px 32px', width:420, boxShadow:'0 20px 60px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ display:'flex', gap:10, justifyContent:'flex-end' }}>
              <button
                ...
                style={{ padding:'var(--ds-btn-py) 18px', borderRadius: 'var(--r)', border:'1px solid var(--border)', background:'var(--white)', color:'var(--ink2)', fontSize:13, fontWeight:600, cursor:'pointer' }}
              >
                Cancel
              </button>
              <button
                onClick={startUpdate}
                style={{ padding:'var(--ds-btn-py) 20px', borderRadius: 'var(--r)', border:'none', background:'var(--teal)', color:'#fff', fontSize:13, fontWeight:700, cursor:'pointer' }}
              >
                Update Now
              </button>
            </div>
