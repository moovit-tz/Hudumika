  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--bg)', fontFamily: 'var(--font)' }}>
      <PageHeader 
        ...
        actions={
          <button onClick={printCertificate} style={{ background: '#059669', color: '#fff', border: 'none', borderRadius: 'var(--r)', padding: 'var(--ds-btn-py) 16px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer', minHeight: 'var(--ctl-h)', boxSizing: 'border-box'}}>
