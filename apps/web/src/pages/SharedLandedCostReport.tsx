  ...
  if (unlocked) return shell(
    <>
      ...
      <button type="button" onClick={download}
        style={{ width: '100%', padding: '13px 20px', borderRadius: 10, border: 'none', background: '#FF5E1A', color: '#fff', fontWeight: 700, fontSize: 14.5, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 9 }}>
    ...
    <>
      ...
      <form onSubmit={unlock}>
        ...
        <button type="submit" disabled={submitting}
          style={{ width: '100%', padding: '13px 20px', borderRadius: 10, border: 'none', background: submitting ? '#C9CED3' : '#FF5E1A', color: '#fff', fontWeight: 700, fontSize: 14.5, cursor: submitting ? 'not-allowed' : 'pointer' }}>
