            ...
            {!occupancyLoading && occupancy?.map(z => (
              <SectionCard key={z.zone} title={z.zone} action={
                <div style={{ display: 'flex', gap: 10, fontSize: 10.5, color: 'var(--ink3)' }}>
                  <span><span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: 2, background: 'var(--green)', marginRight: 4 }} />0-60%</span>
                  <span><span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: 2, background: 'var(--gold)', marginRight: 4 }} />61-85%</span>
