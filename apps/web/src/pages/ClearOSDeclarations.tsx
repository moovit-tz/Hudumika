  ...
  return (
    <div style={{ padding: 24 }}>
      <PageHeader
        ...
        actions={
          <button type="button" className="btn btn-primary" onClick={() => navigate('/clearos/declarations/new')}>
      ...
      <div style={{ background: 'var(--card-bg, var(--white))', border: '1px solid var(--border)', borderRadius: 16, overflow: 'hidden' }}>
        {loading ? (
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {entries.map(e => (
                <tr key={e.id} style={{ borderBottom: '1px solid var(--border)', cursor: 'pointer' }} onClick={() => navigate(`/clearos/declarations/${e.id}`)}>
