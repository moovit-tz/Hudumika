          ...
          {showAddEvent && (
            <div style={{ border: '0.5px solid var(--border)', borderRadius: 9, padding: 12, display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12, background: 'var(--bg)' }}>
              ...
              <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                ...
                <button type="button" onClick={handleAddEvent} style={{ background: '#0b57d0', color: '#fff', border: 'none', padding: 'var(--ds-btn-py-xs) 10px', borderRadius: 'var(--r)', fontSize: 11, fontWeight: 600, cursor: 'pointer' }}>Save</button>
              </div>
            </div>
          )}
          ...
          <div style={{ border: '0.5px solid var(--border)', borderRadius: 9, padding: 12, display: 'flex', flexDirection: 'column', gap: 8, background: newNoteColor }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 }}>
              ...
              <div style={{ display: 'flex', gap: 6 }}>
                ...
                <button type="button" onClick={handleAddNote} style={{ background: '#0b57d0', color: '#fff', border: 'none', padding: 'var(--ds-btn-py-xs) 10px', borderRadius: 'var(--r)', fontSize: 11, fontWeight: 600, cursor: 'pointer' }}>Done</button>
              </div>
            </div>
          </div>
        )}
