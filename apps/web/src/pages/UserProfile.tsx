        ...
        <div style={{ padding: '0 28px 20px', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginTop: -36 }}>
            ...
            <div style={{ display: 'flex', gap: 8, paddingBottom: 4 }}>
              ...
              <button onClick={logout} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: 'var(--ds-btn-py) 16px', border: '1.5px solid var(--border)', borderRadius: 'var(--r)', background: 'var(--white)', cursor: 'pointer', fontSize: 13, fontWeight: 600, fontFamily: 'var(--font)', color: 'var(--red)' }}>
          ...
          <>
            ...
            <Card title="Danger Zone" subtitle="Irreversible actions. Proceed with caution.">
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 0' }}>
                ...
                <button style={{ padding: 'var(--ds-btn-py) 16px', border: '1.5px solid var(--border)', borderRadius: 'var(--r)', background: 'var(--white)', cursor: 'pointer', fontSize: 13, fontWeight: 600, color: 'var(--gold)', fontFamily: 'var(--font)' }}>Deactivate</button>
              </div>
            </Card>
          </>
        )}
