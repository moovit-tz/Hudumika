      ...
      <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, width: isMobile ? '100%' : 680, background: 'var(--white)', zIndex: 1001, display: 'flex', flexDirection: 'column', boxShadow: '-4px 0 32px rgba(0,0,0,0.18)' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{ padding: '12px 24px 0' }}>
            ...
            <button onClick={addRow} style={{ margin: '8px 0 16px', background: 'none', border: '1.5px dashed var(--border)', borderRadius: 7, cursor: 'pointer', color: 'var(--ink3)', padding: '6px 14px', fontSize: 12, fontFamily: 'var(--font)', display: 'flex', alignItems: 'center', gap: 5 }}>
        ...
        <div style={{ padding: '14px 24px', borderTop: '1px solid var(--border)', display: 'flex', gap: 10, justifyContent: 'flex-end', background: 'var(--white)' }}>
          <button onClick={onClose} style={{ padding: '9px 20px', border: '1.5px solid var(--border)', borderRadius: 9, background: 'none', cursor: 'pointer', fontSize: 13, fontWeight: 600, fontFamily: 'var(--font)', color: 'var(--ink)' }}>Cancel</button>
          <button onClick={() => onSave(f)} style={{ padding: '9px 24px', border: 'none', borderRadius: 9, background: 'var(--teal)', cursor: 'pointer', fontSize: 13, fontWeight: 700, fontFamily: 'var(--font)', color: '#fff' }}>Save Note</button>
        </div>
      </div>
    </>
  );
  ...
  return (
    <div style={{ flex: 1, display: 'flex', height: '100%', overflow: 'hidden', fontFamily: 'var(--font)' }}>
      ...
      <PageHeader
        ...
        actions={
          <button type="button" onClick={() => setDrawerNote(newBlankNote())} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', border: 'none', borderRadius: 9, background: 'var(--teal)', color: '#fff', cursor: 'pointer', fontSize: 13, fontWeight: 700, fontFamily: 'var(--font)' }}>
                  ...
                  <td style={{ padding: '12px 10px' }} onClick={e => e.stopPropagation()}>
                    <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
                      <button
                        ...
                        style={{ padding: '5px 8px', border: '1.5px solid var(--border)', borderRadius: 7, background: 'var(--white)', cursor: 'pointer', display: 'flex', alignItems: 'center', color: 'var(--ink)' }}
                      >
                      ...
                      <button
                        ...
                        style={{ padding: '5px 8px', border: '1.5px solid var(--border)', borderRadius: 7, background: 'var(--white)', cursor: 'pointer', display: 'flex', alignItems: 'center', color: 'var(--red)' }}
                      >
