    ...
    <div style={{ flex: 1, display: 'flex', height: '100%', overflow: 'hidden', fontFamily: 'var(--font)' }}>
      ...
      <div style={{ padding: '0 28px 14px', display: 'flex', gap: 10, alignItems: 'center' }}>
        ...
        <button type="button" onClick={exportCsv}
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: 'var(--ds-btn-py) 14px', borderRadius: 'var(--r)', border: '1px solid var(--border)', background: 'var(--white)', color: 'var(--ink2)', fontSize: 12.5, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font)', whiteSpace: 'nowrap' }}>
