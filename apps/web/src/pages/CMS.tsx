              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 28, paddingTop: 20, borderTop: '1px solid var(--border)' }}>
                ...
                <div>
                  ...
                  {[
                    ...
                    <button key={item.label} onClick={item.fn} style={{ display: 'flex', alignItems: 'center', gap: 9, background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: 'var(--teal)', fontWeight: 500, padding: 'var(--ds-btn-py-sm) 0', fontFamily: 'var(--font)', width: '100%', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
                ...
                <div>
                  ...
                  {[
                    ...
                    <button key={item.label} onClick={item.fn} style={{ display: 'flex', alignItems: 'center', gap: 9, background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: 'var(--ink)', fontWeight: 500, padding: 'var(--ds-btn-py-sm) 0', fontFamily: 'var(--font)', width: '100%', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
                ...
                <div>
                  ...
                  {[
                    ...
                    <button key={item.label} onClick={item.fn} style={{ display: 'flex', alignItems: 'center', gap: 9, background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: 'var(--ink2)', fontWeight: 500, padding: 'var(--ds-btn-py-sm) 0', fontFamily: 'var(--font)', width: '100%', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
                      <Icon name={item.icon} size={13} /> {item.label}
                    </button>
                  ))}
                  {user?.role === 'SUPER_ADMIN' && (
                    <button onClick={() => navigate('/admin/cms-pages')} style={{ display: 'flex', alignItems: 'center', gap: 9, background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: 'var(--ink2)', fontWeight: 500, padding: 'var(--ds-btn-py-sm) 0', fontFamily: 'var(--font)', width: '100%', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <div style={{ display: 'flex', gap: 4 }}>
                {(['all', 'published', 'draft', 'trash'] as const).map(f => {
                  ...
                  return (
                    <button key={f} onClick={() => setPFilter(f)} style={{ padding: 'var(--ds-btn-py-sm) 13px', border: 'none', borderRadius: 'var(--r-sm)', background: pFilter === f ? 'var(--teal)' : 'var(--bg)', color: pFilter === f ? '#fff' : 'var(--ink3)', fontWeight: 600, fontSize: 12, cursor: 'pointer', fontFamily: 'var(--font)', transition: 'all 0.1s', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
