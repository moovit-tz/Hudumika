              ...
              <tr key={p.id} style={{ borderTop: '1px solid var(--border)' }}>
                ...
                <td style={{ padding: '10px 14px' }}>
                  <button type="button" onClick={() => toggleEnabled(p)}
                    style={{ fontSize: 11, fontWeight: 700, borderRadius: 20, padding: 'var(--ds-btn-py-xs) 12px', border: 'none', cursor: 'pointer', background: p.enabled ? '#ecfdf5' : '#f1f5f9', color: p.enabled ? '#065f46' : '#64748b', minHeight: 'var(--ctl-h-xs)', boxSizing: 'border-box'}}>
                ...
                <td style={{ padding: '10px 14px', textAlign: 'right' }}>
                  <button type="button" title="Remove" onClick={() => remove(p.id)}
                    style={{ border: '1px solid var(--border)', background: 'var(--bg)', borderRadius: 'var(--r)', padding: 'var(--ds-btn-py-sm) 8px', cursor: 'pointer', color: '#dc2626', minHeight: 'var(--ctl-h-sm)', boxSizing: 'border-box'}}>
