              ...
              <tr key={p.id} style={{ borderTop: '1px solid var(--border)' }}>
                ...
                <td style={{ padding: '10px 14px' }}>
                  <button type="button" onClick={() => toggleEnabled(p)}
                    style={{ fontSize: 11, fontWeight: 700, borderRadius: 20, padding: 'var(--ds-btn-py-xs) 12px', border: 'none', cursor: 'pointer', background: p.enabled ? '#ecfdf5' : '#f1f5f9', color: p.enabled ? '#065f46' : '#64748b', minHeight: 'var(--ctl-h-xs)', boxSizing: 'border-box', lineHeight: 1.25}}>
