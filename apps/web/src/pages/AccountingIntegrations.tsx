...
const MARKETPLACE: MarketplaceItem[] = [
  ...
  { id: 'square',      name: 'Square',           category: 'Payments',       color: 'var(--ink)', bg: 'rgba(17,24,39,0.1)',    initials: 'SQ', desc: 'Point-of-sale and invoicing with automatic journal entries.',                        tags: ['payments', 'pos', 'invoices'] },
