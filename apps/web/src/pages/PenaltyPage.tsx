        ...
        <div style={{ background: 'var(--white)', border: '1px solid var(--border)', borderRadius: 16, padding: 28 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 }}>
            <button type="button" onClick={() => setStep(1)}
              style={{ padding: 'var(--ds-btn-py) 24px', borderRadius: 'var(--r)', border: '1px solid var(--border)', background: 'var(--white)', color: 'var(--ink2)', fontWeight: 600, fontSize: 13, cursor: 'pointer' }}>
              ← Back
            </button>
            <button
              type="button"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button type="button" onClick={resetAll}
              style={{ padding: 'var(--ds-btn-py) 24px', borderRadius: 'var(--r)', border: '1px solid rgba(13, 148, 136, 0.3)', background: 'var(--teal-l, rgba(13, 148, 136, 0.08))', color: 'var(--teal, #0d9488)', fontWeight: 600, fontSize: 13, cursor: 'pointer' }}>
